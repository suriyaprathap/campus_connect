...
const Login = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: `url("https://www.saec.ac.in/img/saecwall3.jpg")`,
      ...
      <div className="flex flex-col items-center mt-10 space-y-32">
        ...
        <div className="h-96 w-80 space-y-11 shadow-2xl flex flex-col justify-center items-center bg-transparent backdrop-blur-md bg-[#f5d52a] bg-opacity-60 rounded-xl">
          ...
          <div className="h-96 w-80 space-y-11 shadow-2xl flex flex-col justify-center items-center bg-transparent backdrop-blur-md bg-[#5a51d6] bg-opacity-60 rounded-xl">
          ...
          <div className="h-96 w-80 space-y-11 shadow-2xl flex flex-col justify-center items-center bg-transparent backdrop-blur-md bg-[#d65158] bg-opacity-60 rounded-xl">
